...
for (const relative of ['.env', 'data/guilds.json', 'data/guilds.json.bak', 'data/bot.lock', 'data/stop.request', 'data/speaker-label-cache', 'data/bot.log', 'data/bot-old.log', 'bot.log', 'bot-old.log', 'temp', ...(!includeRuntime ? ['runtime'] : [])]) {
