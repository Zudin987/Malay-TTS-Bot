...
if (!config.clientId) {
  console.error('Missing DISCORD_CLIENT_ID in .env. The bot runtime can start without it, but slash-command deployment requires the Discord application client ID.');
  process.exitCode = 1;
} else {
