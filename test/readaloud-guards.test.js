...
test('all normal user-authored text bypasses conversational Gemini Live', () => {
  for (const value of [
    ...
    'mushoku tensei dah nak habis kan?', 'boruto dah habis kan?',
    'malaysia merdeka 31 bulan 8 ke?', 'windows ke linux bagus?',
    'windows ke linux bagus'
